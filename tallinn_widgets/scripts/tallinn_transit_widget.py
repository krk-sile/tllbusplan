#!/usr/bin/env python3
"""Build payload for the Tallinn public transit dashboard widget."""
...
from tallinn_widget_lib import build_transit_payload, read_json_file
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build Tallinn transit widget payload")
    parser.add_argument(
        "--config",
        required=False,
    ...
    result = build_transit_payload(conf)
